...
candidate_database = {
    ...
    "Jo": [
        "Jo",
        "0xa2a9f87F936De74607d389e76CF5D9d53c6b1769",
        "4.7",
        0.19,
        "jo.jpeg",
    ],
    "Kendall": [
        "Kendall",
        "0xcC263cf911349e3Ac128f325058289CE5177321a",
        "4.1",
        0.16,
        "kendall.jpeg",
    ],
...
hourly_rate = candidate_database[candidate][3]
...
# YOUR CODE HERE
# 1. Get user input
#person = st.selectbox("Select a fintech professional", candidate_database.keys())
#hours = st.number_input("Enter the number of hours to hire the worker", min_value=1)
...
# 3. Display wage in sidebar
st.sidebar.write(f"The worker will be paid {wage:.2f} ether.")


# @TODO
# Write the `wage` calculation to the Streamlit sidebar
st.sidebar.write(f"Wage Calculation is {hourly_rate} X {hours} = {wage}")
...
if st.sidebar.button("Send Transaction"):
    ...
    # YOUR CODE HERE
    # Get the candidate's Ethereum address from the candidate database
    #candidate_address = candidate_database[person][2]
